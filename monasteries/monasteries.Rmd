...
subtitle: "Opened in the years between 1000 and 1600"
author: Daniel Moul
date: "2020-08-01"
output:
...
```{r}
d <- bind_rows(
  read_xlsx('./data/1-s2.0-S2352340919310868-mmc2.xlsx', sheet = "Cistercians") %>%
    mutate(Latitude = as.numeric(Latitude),
           order = "Cistercians"),
  read_xlsx('./data/1-s2.0-S2352340919310868-mmc2.xlsx', sheet = "Franciscans") %>%
...
d_for_plot_cistercian %>%
  ...
  labs(title = "Rise and decline of Cistercian monasteries",
       subtitle = glue("European countries with at least 100 monasteries.", 
