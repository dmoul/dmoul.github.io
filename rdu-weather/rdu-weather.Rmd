...
rdu_daily_raw <- read_csv(here('rdu-weather/data', 'raw/rdu-daily/2190102-daily.csv'))
...
rdu_records_raw <- read_csv(here('rdu-weather/data', "raw/rdu-daily/rdu-records.csv"),
                            skip = 1,
                            comment = "#") %>%
  clean_names
...
if(!file.exists(here('rdu-weather/data', 'processed/precip-normals.txt'))) {
  ...
  write_csv(precip_normals, here('rdu-weather/data', 'processed/precip-normals.txt'))
} else {
  precip_normals <- read_csv(here('rdu-weather/data', 'processed/precip-normals.txt'))
}
...
if(!file.exists(here('rdu-weather/data', 'processed/tmax-normals.txt'))) {
  ...
  tmax_normals = read_csv(here('rdu-weather/data', 'processed/tmax-normals.txt'))
}
...
if(!file.exists(here('rdu-weather/data', 'processed/tmin-normals.txt'))) {
  # get it from ftp://ftp.ncdc.noaa.gov/pub/data/normals/1981-2010/products/temperature/
  ...
  tmin_normals = read_csv(here('rdu-weather/data', 'processed/tmin-normals.txt'))
}
...
rdu_norm_ytd_raw <- read_csv(here('rdu-weather/data', "raw/climate-normals/rdu/2190343.csv"),
                             guess_max = 11000) %>%
